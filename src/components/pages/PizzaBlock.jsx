...
const PizzaBlock = ({id,name,imageUrl,price,types,sizes,onClickAddPizza,addedPizzasInCart}) => {
...
const onAddPizza = () => {
  const obj = {
   ...
   imageUrl,
   price,
   size: pizzaSize[activePizzaSize],
    ...
    return (
               ...
               <div className="pizza-block__bottom">
                 ...
                 <button onClick={onAddPizza} className="button button--outline button--add">
                   ...
                   <span>Добавить</span>
                   {addedPizzasInCart ? <i>{addedPizzasInCart}</i> : ''}
                 </button>
               </div>
               </div>
